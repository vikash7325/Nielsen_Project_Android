...
public class ProductFeature extends Activity implements TextToSpeech.OnInitListener{
	Button search,blindupc,blindpageno,blindpagesize;
	ImageButton audio,audiopageno,audiopagesize;
	...
	boolean upcAudioClicked=false,pageNoAudioClicked=true,pageSizeAudioClicked=false;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		audiopageno=(ImageButton)findViewById(R.id.imagebutton22);
		audiopagesize=(ImageButton)findViewById(R.id.imagebutton222);
		...
		audiopageno.setOnClickListener(new OnClickListener() {
		...
		audiopagesize.setOnClickListener(new OnClickListener() {
	...
	private Runnable speechThread = new Runnable(){
		public void run(){
			...
			if(b1){
				...
				String text = "Click here to search";
				tts.setLanguage(Locale.UK);
				tts.speak(text, TextToSpeech.QUEUE_FLUSH, null);
				b4=false;
			}
